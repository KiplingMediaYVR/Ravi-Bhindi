  ...
  <div class="rps-result rps-grid-result">
    ...
    <!-- <div class="row"> -->
      ...
      <?php } else {
        ...
        $grid_cols = explode( ',', get_option( 'rps-result-grid-columns', '12,4,3' ) ) ?>
        ...
        <?php foreach( $query->posts as $post ) : ?>
          ...
          ?>
            ...
            <section class="col-xs-<?php echo $grid_cols[0] ?> col-sm-<?php echo $grid_cols[1] ?> col-md-<?php echo $grid_cols[2] ?> listing-container">
