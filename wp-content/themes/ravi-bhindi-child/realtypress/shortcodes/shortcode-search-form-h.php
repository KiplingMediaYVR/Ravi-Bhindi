                            ...
                            <?php if (empty($hide['bedrooms'])) { ?>
                                <?php if (get_option('rps-search-form-range-enabled', 1) == 1) { ?>
                                    ...
                                    <div class="jrange-input">
                                        <label for="input_bedrooms">
                                            <small><?php _e('Bedrooms', 'realtypress-premium') ?></small>
                                        </label>
                                        <div class="range">
                                                ...
                                                <select name="bedrooms_min" class="form-control range_bed_dd">
                                                    ...
                                                    <?php for ($i = (REALTYPRESS_RANGE_BEDS_MIN - 1); $i < $bed_options; $i++) { ?>
                                                        <option value="<?php echo($i + REALTYPRESS_RANGE_BEDS_STEP) ?>">
                                                            ...
                                                            <?php if (($i + REALTYPRESS_RANGE_BEDS_STEP) == $bed_options) {
                                                                echo '+';
                                                            } ?>
                                                        </option>
                                                    <?php } ?>
                        ...
                        <div class="col-12 col-md-4">
                            <?php if (empty($hide['bathrooms'])) { ?>
                                <?php if (get_option('rps-search-form-range-enabled', 1) == 1) { ?>
                                    ...
                                    <div class="jrange-input">
                                        <label for="input_baths">
                                            <small><?php _e('Bathrooms', 'realtypress-premium') ?></small>
                                        </label>
                                        <div class="range">
                                                ...
                                                <select name="bathrooms_min" class="form-control range_bath_dd">
                                                    ...
                                                    <?php for ($i = (REALTYPRESS_RANGE_BEDS_MIN - 1); $i < $bath_options; $i++) { ?>
                                                        <option value="<?php echo($i + REALTYPRESS_RANGE_BATHS_STEP) ?>">
                                                            ...
                                                            <?php if (($i + REALTYPRESS_RANGE_BATHS_STEP) == $bath_options) {
                                                                echo '+';
                                                            } ?>
                                                        </option>
                                                    <?php } ?>
                                ...
                                <?php if (get_option('rps-search-form-range-enabled', 1) == 1) { ?>
                                    ...
                                    <div class="jrange-input">
                                        <label for="input_price">
                                            <small><?php _e('Price', 'realtypress-premium') ?></small>
                                        </label>
                                        <div class="range">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <?php if (empty($hide['type'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_property_type">
                                            <small><?php _e('Property Type', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php }
                            ...
                            <?php if (empty($hide['business'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_business_type">
                                            <small><?php _e('Business Type', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php }
                            ...
                            <?php if (empty($hide['transaction'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_transaction_type">
                                            <small><?php _e('Transaction Type', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php }
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_building_type">
                                            <small><?php _e('Building Type', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php }
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <?php if (empty($hide['street_address'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_street_address">
                                            <small><?php _e('Street Address', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_city">
                                            <small><?php _e('City', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
                                    <input type="text" id="input_city" name="input_city" value="" class="form-control " placeholder="Vancouver">
                                </div>
                            <?php } ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_community_name">
                                            <small><?php _e('Community', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
                            ...
                            <?php if (empty($hide['neighbourhood'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_neighbourhood">
                                            <small><?php _e('Neighbourhood', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
                            ...
                            <?php if (empty($hide['province'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_province">
                                            <small><?php _e('Province', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php }
                            ...
                            <?php if (empty($hide['postal_code'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_postal_code">
                                            <small><?php _e('Postal Code', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
                            ...
                            <?php if (empty($hide['mls'])) { ?>
                                ...
                                <div class="form-group">
                                    <?php if (!empty($labels)) { ?>
                                        <label for="input_mls">
                                            <small><?php _e('MLS&reg; or RP Number', 'realtypress-premium') ?></small>
                                        </label>
                                    <?php } ?>
